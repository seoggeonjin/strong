package net.ua.mixin2.inner.goals.CreeperMixin;
...
public class CreeperIgniteGoal3 extends Goal {

    private final ze2 creeper;
    @Nullable
    private LivingEntity target;

    public CreeperIgniteGoal3(ze2 creeper) {
